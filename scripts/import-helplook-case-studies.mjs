...
const sections = [
  ...
  },
  {
    ...
    pages: [
      ...
      ["【小红书】一级评论采集", "xiao-hong-shu-yi-ji-ping-lun-cai-ji", "xiaohongshu-first-level-comments"],
      ["【小红书】博主主页笔记采集", "xiao-hong-shu-bo-zhu-ye-zhu-ye-bi-ji-cai-ji", "xiaohongshu-author-notes"],
      ["【小红书】搜索关键词采集", "xiao-hong-shu-sou-suo-guan-jian-ci-cai-ji", "xiaohongshu-keyword-search"],
      ["【小红书】详情页采集", "xiao-hong-shu-xiang-qing-ye-cai-ji", "xiaohongshu-detail"],
