...
八爪鱼 CLI 是面向开发者、数据团队、运维和 AI Agent 场景的命令行工具。v0.1.28 补齐了远端任务管理、任务组、模板任务、云定时和数据预览能力；v0.1.27 的 Agent 任务修正与 API 列表候选能力继续适用。
...
<Steps>
  <Step title="安装 CLI">
    使用 `npm install -g bazhuayu-cli@0.1.28` 安装，并运行 `octopus doctor` 检查环境。
  </Step>
  <Step title="登录认证">
