---
title: 环境诊断
description: 使用 octopus doctor、browser status 与 auth status 检查八爪鱼 CLI 环境、浏览器依赖与登录状态。
---
...
## `octopus browser status`（检查用户浏览器）
...
| 安装 `@latest` 卡住 | 使用固定版本：`npm install -g bazhuayu-cli@0.1.30` |
