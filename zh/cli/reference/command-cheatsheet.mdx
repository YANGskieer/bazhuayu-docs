---
title: 命令速查表
description: 八爪鱼 CLI v0.1.22 常用命令快速参考。
---
...
octopus run-url <url> --select candidate_001
octopus run-url <url> --auto --input keyword=烤面包机
...
octopus task validate --task-file <file.json|file.xml|file.otd>
```
