...
octopus detect URL --agent --agent-command "node make-plan.mjs" --goal "提取用户评论" --run-sample 3 --json
    ...
    "nextActions": [
      {
        ...
        "command": "octopus browser install --browser-id chrome --profile \"Default\" --json"
      }
    ]
  }
}
