...
description: 2026 年 6 月八爪鱼文档更新，包含 CLI v0.1.25 detector 重构与任务同步客户端、采集学院新增规则排错与优化栏目（7 篇文章从帮助中心迁入），以及 MCP AI 客户端教程。
---

# 2026 年 6 月发布说明

> **更新日期：** 2026 年 6 月 17 日
> CLI 当前版本更新至 v0.1.25；detector 模块重构、候选区排序与分页识别改进、detect 任务同步客户端、弹窗筛选优化。采集学院新增「规则排错与优化」栏目，从帮助中心迁入 7 篇排错与流程优化文章。保留 v0.1.24、v0.1.23、v0.1.22 历史记录。
