...
description: 2026 年 6 月八爪鱼文档更新，包含 CLI v0.1.27 Agent 任务修正、API 列表候选、可见 DOM 字段选择与字段名规范化，以及采集学院、数据导出、XPath 学习与案例栏目更新。
---

# 2026 年 6 月发布说明

> **更新日期：** 2026 年 6 月 26 日
> CLI 升级至 v0.1.27（Agent 任务修正、API 列表候选、可见 DOM 字段选择、自定义候选区、字段名规范化、doctor 诊断增强）。保留 v0.1.26 以及之前所有更新内容。
