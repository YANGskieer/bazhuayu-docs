...
description: 2026 年 6 月八爪鱼文档更新，包含 CLI v0.1.25 detector 重构与任务同步客户端、采集学院新增规则排错与优化栏目（7 篇文章从帮助中心迁入）、数据导出栏目（7 篇文章从帮助中心迁入），以及 MCP AI 客户端教程。
---

# 2026 年 6 月发布说明

> **更新日期：** 2026 年 6 月 18 日
> 新增「数据导出」栏目，从帮助中心迁入 7 篇数据导出文章。保留之前所有更新内容。
