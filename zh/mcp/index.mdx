...
数据中心交付的是**提前采集的存量数据**：用户发起查询时直接检索已有内容，不必等待临时创建网页采集任务。其覆盖量级为数百个国内外网站、20+ 语种，并持续扩充；内容横跨社交社区、新闻资讯、财经证券、汽车、消费维权、招投标和海外媒体，数据形态包括网页、图片与视频。具体记录总量会随持续采集增长，实时支持的平台与域名以 [`list_platforms`](/zh/mcp/list-platforms) 返回为准。

代表性网站包括 X（Twitter）、Facebook、微信公众号、知乎、豆瓣、哔哩哔哩、百度贴吧、人民网、新华网、澎湃新闻、36氪、东方财富、雪球、懂车帝、汽车之家、黑猫投诉、中国政府采购网、Reuters、Bloomberg、Yahoo! JAPAN、Naver 等。完整分类与使用边界见[数据中心平台清单](/zh/mcp/list-platforms)。
